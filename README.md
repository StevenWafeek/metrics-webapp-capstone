...
# 📖 Pokemon list <a name="about-project"></a>

> pokemon list

**[pokemon list]** is react project it shows some of the pokemons details of powers and moves
...
`git clone`
`https://github.com/StevenWafeek/metrics-webapp-capstone`
